...
// pi is the nonlinear bijection (S-box) from ГОСТ Р 34.11-2012 / RFC 6986.
var pi = [256]byte{
...
// tau is the transposition (permutation P) from ГОСТ Р 34.11-2012.
var tau = [64]int{
...
// c contains the 12 round constants C[1]..C[12] for the key schedule.
// Defined explicitly in RFC 6986 / ГОСТ Р 34.11-2012.
var c = [12][64]byte{
	{
...
// a is the matrix of linear transformation L from ГОСТ Р 34.11-2012 / RFC 6986.
var a [64]uint64

// cache is the precomputed L-transformation lookup table.
var cache [8][256]uint64
...
func init() {
	...
	// Precompute L-transformation cache for fast lookup.
